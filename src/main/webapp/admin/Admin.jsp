...
<!-- Nav Item - Tables -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Freelancer.dev</span>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="Admin.jsp" data-toggle="modal" data-target="#logoutModal">
        ...
        <!-- Begin Page Content -->
			...
			<input type="button" value="Approve" onclick="update_proj();"
			class="btn btn-warning btn-user" />
			<input type="button" value="Reject" onclick="delete_user();"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button class="close" type="button" data-dismiss="modal" aria-label="Close" onclick="logout()">
  ...
  <script>
	...
	var databaseRef2 = firebase.database().ref('approve/');
	var rowIndex = 1;
	...
	function delete_user(){
		...
		firebase.database().ref().child('/project/' + uid).remove();
	...
	function update_proj(){
		...
		var updates = {}; updates['/approve/' + uid] = data; firebase.database().ref().update(updates);
		
		alert('Project request has approve!');
		delete1_proj();
		reload_page();
